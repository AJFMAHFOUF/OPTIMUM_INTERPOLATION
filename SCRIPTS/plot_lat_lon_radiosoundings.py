...
lat1,lon1 = np.loadtxt('../../DATA/NOAA_CDR/location_radiosoundings_global.txt',unpack=True)
lat2,lon2 = np.loadtxt('../../DATA/NOAA_CDR/location_radiosoundings_global_2023.txt',unpack=True)
...
#cs = m.scatter(x1,y1,1,marker='o',color='black')
cs = m.scatter(x2,y2,4,marker='s',color='red')
...
plt.title("RADIOSOUNDING STATIONS (2023)")
#plt.title("T 850 hPa - ERA5 - first guess - resol 1.5°")
plt.savefig('../PLOTS/radiosounding_stations_2023.png')
plt.show()
